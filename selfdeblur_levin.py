...
def parse_args():
    ...
    parser.add_argument('--blurred_images_dir', type=str, default='./datasets/levin/blurry',
                        help='path of blurred images')
    parser.add_argument('--deblurred_image_output_dir', type=str, default='./deblurred_results/levin/x',
                        help='path of deblurred result')
    parser.add_argument('--kernel_output_dir', type=str, default='./deblurred_results/levin/k',
...
if __name__ == '__main__':
    ...
    for image_name in image_names:
        ...
        if kernel_number == 'kernel1':
            kernel_size = [17, 17]
        elif kernel_number == 'kernel2':
            kernel_size = [15, 15]
        elif kernel_number == 'kernel3':
            kernel_size = [13, 13]
        elif kernel_number == 'kernel4':
            kernel_size = [27, 27]
        elif kernel_number == 'kernel5':
            kernel_size = [11, 11]
        elif kernel_number == 'kernel6':
            kernel_size = [19, 19]
        elif kernel_number == 'kernel7':
            kernel_size = [21, 21]
        elif kernel_number == 'kernel8':
            kernel_size = [21, 21]
